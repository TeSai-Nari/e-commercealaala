            ...
            return (
                ...
                <Modal isOpen={this.state.isModaladdOpen} toggle={this.toggleadd}>
                    ...
                    <ModalBody>
                        ...
                        <textarea cols='20' rows='5' ref='deskripsiadd' placeholder='Product Description'></textarea>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal isOpen={this.state.isModaleditOpen} toggle={this.toggleedit}>
                    ...
                    <ModalBody>
                        ...
                        <textarea cols='20' rows='5' ref='deskripsiedit' defaultValue={products[indexedit].deskripsi} placeholder='Product Description'></textarea>
                    </ModalBody>
                    <ModalFooter>
